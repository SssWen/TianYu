...
// 
Shader "Low/Tianyu Shaders/Character/CharacterSkinTemp"
{
    Properties
    {
    ...
    // u_xlat16_19.x = dot(u_xlat0.xyz, _CharacterLightDir.xyz);
        ...
        //
                ...
                // VdotN = SRGBToLinear(VdotN);
                // worldNormal = SRGBToLinear(worldNormal);
                ...
                // SSSlut2 = pow(SSSlut2,2.2);
                
                // SSSlut2 = SRGBToLinear(SSSlut2);
                // float3 tt = float3(lutUV2XY.x,lutUV2XY.x,lutUV2XY.x);
                // SSSlut2 = SRGBToLinear(SSSlut2);
                // return float4(SSSlut2,1.0);
                ...
                // diffParam3= SRGBToLinear(diffParam3);
                // return  float4(diffParam3,1);
                
                diffuse = diffParam3 * _MainColorTemp.xyz + CharacterSkinColor.xyz;
                
                // diffuse =  _MainColorTemp.xyz;// + CharacterSkinColor.xyz; // ok
...
// ---------------------------------------specular----------------------
                ...
                // specularColor = specularColor*20;
