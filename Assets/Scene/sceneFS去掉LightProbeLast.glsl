...
void main()
{
    ...
    vec4 mainTexColor = texture(_MainTex, vs_TEXCOORD3.xy);
    // u_xlat16_3 = texture(_BumpMap, vs_TEXCOORD3.xy);
    vec4 Normal = texture(_BumpMap, vs_TEXCOORD3.xy);
    vec4 _BumpMapTex = Normal;
    u_xlat16_4.xy = Normal.xy * vec2(2.0, 2.0) + vec2(-1.0, -1.0);
    u_xlat16_31.xy = texture(_ParamTex, vs_TEXCOORD3.xy).yw;
    // vec4 _ParamTexColor = texture(_ParamTex, vs_TEXCOORD3.xy);    
    _BumpMapTex.xy = texture(_ParamTex2, vs_TEXCOORD3.xy).yw;
    u_xlat16_6.xyz =  mainTexColor.xyz;

// 去掉lips

//     vec3 worldNormal = vec3(vs_TEXCOORD0.z, vs_TEXCOORD1.z, vs_TEXCOORD2.z);
//     u_xlat16_49 = dot(viewDir.xyz, worldNormal.xyz);
...
//     u_xlat16_8.x = dot((-viewDir.xyz), worldNormal.xyz);
//     u_xlat16_8.x = u_xlat16_8.x + u_xlat16_8.x;
//     u_xlat16_8.xyz = worldNormal.xyz * (-u_xlat16_8.xxx) + (-viewDir.xyz);
...
//     u_xlat16_8.xyz = _BumpMapTex.zzz * u_xlat16_8.xyz;
//     // u_xlat16_6.xyz = u_xlat16_8.xyz * _FacialParams.xxx + u_xlat16_6.xyz;
    ...
    u_xlat16_38.xy = _BumpMapTex.ww * u_xlat16_38.xy + vec2(1.0, 1.0);
    u_xlat16_8.xy = (-u_xlat16_4.xy) + u_xlat16_8.xy;
    u_xlat16_9.xy = _BumpMapTex.ww * u_xlat16_8.xy + u_xlat16_4.xy;
    u_xlat16_9.z = 1.0;
    ...
    u_xlat16_49 = _BumpMapTex.z * _FacialParams.x;
    u_xlat16_51 = (-mainTexColor.w) + _FacialParams.y;
    u_xlat16_4.w = u_xlat16_49 * u_xlat16_51 + mainTexColor.w;
    u_xlat16_4.z = 1.0;
    ...
    u_xlat16_9.xyz = _SSSLightColor2.xyz;
    ...
    u_xlat16_8.x = _BumpMapTex.x * u_xlat16_51;
    u_xlat16_16 = (-_BumpMapTex.x) * u_xlat16_51 + 0.0500000007;
