...
void main()
{
    ...
    u_xlatb20.xz = lessThan(vec4(1.0, 0.0, 2.0, 2.0), vec4(vec4(_SoftShadowType, _SoftShadowType, _SoftShadowType, _SoftShadowType))).xz;
    ...
    u_xlat8 = (u_xlatb20.x) ? u_xlat8 : u_xlat9;
    if(u_xlatb20.z){
        u_xlat4.xy = u_xlat8.xy / u_xlat8.ww;
        u_xlat55 = texture(_CustomShadowTex, u_xlat4.xy).x;
        u_xlat56 = u_xlat8.z + (-_CustomShadowBias);
#ifdef UNITY_ADRENO_ES3
        ...
        u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(0.249529794, 0.732074976) + u_xlat8.xy;
        u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
        u_xlat40 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb40 = !!(u_xlat56<u_xlat40);
#else
        u_xlatb40 = u_xlat56<u_xlat40;
#endif
        u_xlat40 = u_xlatb40 ? 1.0 : float(0.0);
        u_xlat16_5.x = u_xlat55 + u_xlat40;
        u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(-0.346920609, 0.643783629) + u_xlat4.xy;
        u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
        u_xlat55 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb55 = !!(u_xlat56<u_xlat55);
#else
        u_xlatb55 = u_xlat56<u_xlat55;
        ...
        u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(-0.0187890902, 0.482739389) + u_xlat4.xy;
        u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
        u_xlat55 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb55 = !!(u_xlat56<u_xlat55);
        ...
        u_xlat55 = u_xlatb55 ? 1.0 : float(0.0);
        u_xlat16_5.x = u_xlat55 + u_xlat16_5.x;
        u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(-0.272521287, 0.896188021) + u_xlat4.xy;
        u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
        u_xlat55 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb55 = !!(u_xlat56<u_xlat55);
        ...
        u_xlat55 = u_xlatb55 ? 1.0 : float(0.0);
        u_xlat16_5.x = u_xlat55 + u_xlat16_5.x;
        u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(-0.681433618, 0.648048103) + u_xlat4.xy;
        u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
        u_xlat55 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb55 = !!(u_xlat56<u_xlat55);
        ...
        u_xlat55 = u_xlatb55 ? 1.0 : float(0.0);
        u_xlat16_5.x = u_xlat55 + u_xlat16_5.x;
        u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(0.415204495, 0.279417187) + u_xlat4.xy;
        u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
        u_xlat55 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb55 = !!(u_xlat56<u_xlat55);
        ...
        u_xlat55 = u_xlatb55 ? 1.0 : float(0.0);
        u_xlat16_5.x = u_xlat55 + u_xlat16_5.x;
        u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(0.1310554, 0.26759249) + u_xlat4.xy;
        u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
        u_xlat55 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb55 = !!(u_xlat56<u_xlat55);
        ...
        u_xlat55 = u_xlatb55 ? 1.0 : float(0.0);
        u_xlat16_5.x = u_xlat55 + u_xlat16_5.x;
        u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(0.534474373, 0.562441111) + u_xlat4.xy;
        u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
        u_xlat55 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb55 = !!(u_xlat56<u_xlat55);
        ...
        u_xlat55 = u_xlatb55 ? 1.0 : float(0.0);
        u_xlat16_5.x = u_xlat55 + u_xlat16_5.x;
        u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(0.838568926, 0.513734818) + u_xlat4.xy;
        u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
        u_xlat55 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb55 = !!(u_xlat56<u_xlat55);
        ...
        u_xlat55 = u_xlatb55 ? 1.0 : float(0.0);
        u_xlat16_5.x = u_xlat55 + u_xlat16_5.x;
        u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(0.604505181, 0.0839385688) + u_xlat4.xy;
        u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
        u_xlat55 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb55 = !!(u_xlat56<u_xlat55);
        ...
        u_xlat55 = u_xlatb55 ? 1.0 : float(0.0);
        u_xlat16_5.x = u_xlat55 + u_xlat16_5.x;
        u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(0.464316308, 0.868464172) + u_xlat4.xy;
        u_xlat4.xy = u_xlat4.xy / u_xlat8.ww;
        u_xlat55 = texture(_CustomShadowTex, u_xlat4.xy).x;
#ifdef UNITY_ADRENO_ES3
        u_xlatb55 = !!(u_xlat56<u_xlat55);
#else
        ...
        if(u_xlatb20.x){
            u_xlat20.xz = u_xlat8.xy / u_xlat8.ww;
            u_xlat55 = texture(_CustomShadowTex, u_xlat20.xz).x;
            u_xlat20.x = u_xlat8.z + (-_CustomShadowBias);
#ifdef UNITY_ADRENO_ES3
            ...
            u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(0.249529794, 0.732074976) + u_xlat8.xy;
            u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
            u_xlat56 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
            u_xlatb56 = !!(u_xlat20.x<u_xlat56);
#else
            u_xlatb56 = u_xlat20.x<u_xlat56;
#endif
            u_xlat56 = u_xlatb56 ? 1.0 : float(0.0);
            u_xlat16_23.x = u_xlat55 + u_xlat56;
            u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(-0.346920609, 0.643783629) + u_xlat4.xy;
            u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
            u_xlat55 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
...
#endif
            u_xlat55 = u_xlatb55 ? 1.0 : float(0.0);
            u_xlat16_23.x = u_xlat55 + u_xlat16_23.x;
            u_xlat4.xy = vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) * vec2(-0.0187890902, 0.482739389) + u_xlat4.xy;
            u_xlat13.xy = u_xlat4.xy / u_xlat8.ww;
            u_xlat55 = texture(_CustomShadowTex, u_xlat13.xy).x;
#ifdef UNITY_ADRENO_ES3
            ...
            u_xlat55 = u_xlatb55 ? 1.0 : float(0.0);
            u_xlat16_23.x = u_xlat55 + u_xlat16_23.x;
            u_xlat16_5.x = u_xlat16_23.x * 0.125;
        } else {
            u_xlatb20.xz = lessThan(vec4(-0.5, 0.0, -1.5, -1.5), vec4(vec4(_SoftShadowType, _SoftShadowType, _SoftShadowType, _SoftShadowType))).xz;
            u_xlat55 = (u_xlatb20.x) ? 12.0 : 8.0;
            u_xlat55 = (u_xlatb20.z) ? u_xlat55 : 4.0;
            u_xlat20.x = u_xlat8.z;
            u_xlat16_23.x = float(0.0);
            u_xlat16_41 = float(0.0);
            while(true){
#ifdef UNITY_ADRENO_ES3
                u_xlatb56 = !!(u_xlat16_41>=u_xlat55);
#else
                u_xlatb56 = u_xlat16_41>=u_xlat55;
#endif
                if(u_xlatb56){break;}
                u_xlatu56 = uint(u_xlat16_41);
#ifdef UNITY_ADRENO_ES3
                u_xlatb4 = !!(u_xlat20.x<0.00999999978);
#else
                u_xlatb4 = u_xlat20.x<0.00999999978;
#endif
                u_xlat20.x = (u_xlatb4) ? 1.0 : u_xlat20.x;
                u_xlat4.xy = ImmCB_0_0_0[int(u_xlatu56)].xy * vec2(PANGU_CHARACTER_SOFT_SHADOW_SOFTNESS) + u_xlat8.xy;
                vec3 txVec0 = vec3(u_xlat4.xy,u_xlat20.x);
                u_xlat16_61 = textureLod(hlslcc_zcmp_ShadowMapTexture, txVec0, 0.0);
                u_xlat16_23.x = u_xlat16_23.x + u_xlat16_61;
                u_xlat16_41 = u_xlat16_41 + 1.0;
            }
            u_xlat16_5.x = u_xlat16_23.x / u_xlat55;
        //ENDIF
        }
    //ENDIF
    }
