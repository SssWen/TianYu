...
//     u_xlat16_59 = _ParamTex2Color.w * u_xlat16_59;
    ...
    u_xlat16_5.w = u_xlat16_59 * u_xlat16_61 + mainTexColor.w;
    u_xlat16_5.z = 1.0;
    ...
    sssDiff.xyz = vec3(u_xlat55) * sssDiff.xyz;
    ...
    u_xlat16_11.x = dot(u_xlat16_11.xyz, viewDirection.xyz);
    ...
    u_xlat16_11.xyz = u_xlat16_23.xxx * u_xlat16_11.xyz;
    u_xlat16_23.x = dot(vec3(_ParamTexColorZ,_ParamTexColorZ,_ParamTexColorZ), vec3(0.300000012, 0.589999974, 0.109999999));
